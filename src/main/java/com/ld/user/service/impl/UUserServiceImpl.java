...
import com.ld.common.model.UUserRole;
...
public class UUserServiceImpl extends BaseMybatisDao<UUserMapper> implements UUserService {
	...
	@Override
	public UUser checklogin(String mobile ,String pswd) {
		Map<String,Object> map = new HashMap<String, Object>();
		map.put("mobile", mobile);
		map.put("pswd", pswd);
		UUser user = userMapper.checklogin(map);
		return user;
	}
	...
	@Override
	public UUser findUserByMobile(String mobile) {
