package com.ld.core.shiro.token.manager;
...
import com.ld.core.shiro.token.SampleRealm;
import com.ld.core.shiro.token.ShiroToken;
...
public class TokenManager {
	...
	public static UUser login(UUser user,Boolean rememberMe){
		ShiroToken token = new ShiroToken(user.getMobile(), user.getPswd());
